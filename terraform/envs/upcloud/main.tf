...
#   kubeconfig_token                  = module.upcloud.kubeconfig_token
#   kubeconfig_cluster_ca_certificate = module.upcloud.kubeconfig_cluster_ca_certificate

#   external_dns_access_key = module.upcloud.external_dns_access_key
#   external_dns_secret_key = module.upcloud.external_dns_secret_key

#   ingress_nginx_zones = module.upcloud.zones
#   cluster_domain          = module.upcloud.domain
