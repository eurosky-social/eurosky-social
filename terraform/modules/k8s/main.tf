...
module "cert_manager" {
  ...
  cloudflare_dns_api_token = var.cert_manager_secrets["api-token"]
...
module "ingress_nginx" {
  ...
  extra_annotations    = var.extra_nginx_annotations
...
module "external_dns" {
  ...
  api_token      = var.external_dns_secrets["CF_API_TOKEN"]
  cluster_domain = var.cluster_domain
...
# TODO: Re-enable PDS after fixing interface incompatibilities
# module "pds" {
